...
class AddSectionDataDialog extends StatefulWidget {
  final void Function(void Function()) innerSetState;

  const AddSectionDataDialog({
    super.key,
    required this.innerSetState,
  });

  @override
  State<AddSectionDataDialog> createState() => _AddSectionDataDialogState();
}

class _AddSectionDataDialogState extends State<AddSectionDataDialog> {
